...
| **头皮脑电 EDA（分布/通道差异/刺激可解码性）** | ✅ | 干净信号带通 0.5-6 Hz 解码 CV R²=0.90、级联滞后 23/17 ms、空间参与秩≈2；前提=果蝇替代人脑（默认仅设备噪声）：PC 空间滤波后单段 SNR>2（0.1-1 Hz 达 10.8）；反事实"与人脑共存"上界需 ~18-65 段平均 | exp018 |
