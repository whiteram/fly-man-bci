...
| **BCI 范式采集分支（SSVEP-Benchmark）** | ✅ | 对齐 Wang 2016（40 类 8-15.8 Hz）；40 类 CCA top-1 干净 70% / 缩放假想设备噪声 82%（随机 2.5%，与人类基准同量级）；SSVEP 频段响应带内 SNR ~27 dB——低频主导是刺激属性而非模型属性 | bci/ssvep_benchmark |
