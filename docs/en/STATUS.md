...
| **Stimuli: other modalities (proprioception/hearing)** | ⏸ planned | proprioception → exp020 (motor imagery); hearing JO+AMMC present in data, untouched by the community | docs/SENSORY_INPUTS.md §4-5 |
