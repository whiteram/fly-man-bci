...
| **BCI paradigm-acquisition branch (SSVEP-Benchmark)** | ✅ | aligned to Wang 2016 (40 classes, 8-15.8 Hz); 40-class CCA top-1 70% clean / 82% with scaled hypothetical equipment noise (chance 2.5%, same range as human benchmark); SSVEP-band responses ~27 dB in-band SNR -- low-frequency dominance was the stimulus, not the model | bci/ssvep_benchmark |
