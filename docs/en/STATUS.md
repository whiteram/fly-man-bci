...
| **Scalp-EEG EDA (distributions / channel differences / stimulus decodability)** | ✅ | clean signal band-passed 0.5-6 Hz decoding CV R2=0.90, cascade lags 23/17 ms, spatial participation rank ~2; premise = fly replaces the brain (default floor: sensor noise only): PC spatial filtering reaches single-clip SNR>2 (up to 10.8 at 0.1-1 Hz); counterfactual coexisting-human-brain bound needs ~18-65 clip-averages | exp018 |
