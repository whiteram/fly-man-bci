...
三电极搏动、头壳线框、右侧四通道电位（眼表面/板层/髓质 + **人脑头皮 ×400**
粉色通道，ScalpPairField S=400）+ 五层放电率实时图表 + 播放控制。右上按钮
**🧠 人脑壳视图**把网络 ×400 缩放进脑/颅骨/头皮三层同心球壳（exp010 几何），
显示挂在头皮外表面的头皮电极——即 exp010/011 思想实验的可视化。
本地服务器打开（python -m http.server），vendor/ 内置 Three.js r128 离线可用。
